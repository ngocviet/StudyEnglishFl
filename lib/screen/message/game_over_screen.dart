...
class GameOverScreen extends StatefulWidget {
  ...
  const GameOverScreen({super.key, required this.onTapContinue, required this.onTapExit});
            ...
            const Column(
              children: [
                Padding(
                  ...
                  child: Text('Bạn đã hết số lượt chơi',
                      style: TextStyle(
                          color: const Color.fromRGBO(19, 157, 243, 1.0),
                          fontSize: 20,
                          fontWeight: FontWeight.bold)),
                ),
                Text('Hãy làm lại phần nay!',
                    style: TextStyle(
                        color: const Color.fromRGBO(19, 157, 243, 1.0),
                        fontSize: 20,
