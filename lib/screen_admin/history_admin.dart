...
// import 'package:project4/screen_admin/detail_history_admin.dart';
...
//     History history = HistoryAdminController.GetHistory();
...
//               width: MediaQuery.of(context).size.width * 0.6,
//               child: Text(
//                 'Create Time: ${history.CreatedTime}',
//                 style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold),
//                 softWrap: true,
//
//               ),
...
//                     Navigator.push(
//                         context,
//                         MaterialPageRoute(builder: (context) => DetailHistoryAdmin(id_history: 1, id_user: 1)
//                         )
//                     );
